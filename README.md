...
```shell
./gsmpc-client -cmd SetGroup -url http://127.0.0.1:5871 --keystore ./keystore1 -ts 2/3 -node http://127.0.0.1:5871 -node http://127.0.0.1:5872 -node http://127.0.0.1:5873 -node http://127.0.0.1:5874 -node http://127.0.0.1:5875
...
```shell
./gsmpc-client -cmd SetGroup -url http://127.0.0.1:5871 --keystore ./keystore1 -ts 2/3 -node http://127.0.0.1:5871 -node http://127.0.0.1:5872
...
```shell
./gsmpc-client -cmd EnodeSig -url http://127.0.0.1:5871 --keystore ./keystore1
./gsmpc-client -cmd EnodeSig -url http://127.0.0.1:5872 --keystore ./keystore2
./gsmpc-client -cmd EnodeSig -url http://127.0.0.1:5873 --keystore ./keystore3
```
...
```shell
./gsmpc-client -cmd ACCEPTSIGN  -url http://127.0.0.1:5871 --keystore ./keystore1 -key 0x5cdbe2981c399336952dee62ee3120674c18fb68a7965c9664a5e4bbcc96b589 --keytype EC256K1 -mode 0

./gsmpc-client  -cmd ACCEPTSIGN -url http://127.0.0.1:5872 --keystore ./keystore2 -key 0x5cdbe2981c399336952dee62ee3120674c18fb68a7965c9664a5e4bbcc96b589 --keytype EC256K1 -mode 0
```
